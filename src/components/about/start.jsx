export default function Start(){
    return(
        <div className="container">
            <div id="aboutstart" style={{marginBottom:"5rem"}} className="row mt-5">
                <div  className="col-6">
...
<p className="mt-4">Rainmatter, our fintech fund and incubator, has invested in several fintech startups with the goal of growing the Indian capital markets.</p>
<p className="mt-4">And yet, we are always up to something new every day. Catch up on the latest updates on our blog or see what the media is saying about us.</p>
                </div>
            </div>
        </div>
    )
