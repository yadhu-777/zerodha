export default function Footer(){
    return(
        <footer style={{backgroundColor:"rgb(233, 238, 245)"}}>
...
<i class="fa-brands fa-telegram"></i>
    ...
    <div className="col  ">
<p id="bold" style={{marginLeft:"2rem"}}>company</p>
<ul style={{lineHeight:"2rem"}} className="line">
    <li>About</li>
    <li>Product</li>
    <li>Pricing</li>
    ...
    <div className="col"><p  id="bold" style={{marginLeft:"2rem"}}>Support</p>
    ...
    <div className="col">
    <p   id="bold"style={{marginLeft:"2rem"}}>Account</p>
 ...
 <li>Fund transfer</li>
   ...
   <div style={{fontSize:"10px", marginTop:"4rem"}}>
   ...
   <div id="footerchange" className="footer-text"  style={{fontSize:"11px", marginTop:"1rem"}}>
 <p>NSE</p>
 <p>BSE</p>
 <p>MCX</p>
